...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.date_created'
        db.add_column(u'config_certificate', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'Certificate.device'
        db.add_column(u'config_certificate', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mdm.Device'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CertificateAuthority.date_created'
        db.add_column(u'config_certificateauthority', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 27, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.date_created'
        db.delete_column(u'config_certificate', 'date_created')

        # Deleting field 'Certificate.device'
        db.delete_column(u'config_certificate', 'device_id')

        # Deleting field 'CertificateAuthority.date_created'
        db.delete_column(u'config_certificateauthority', 'date_created')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceGroup.priority'
        db.add_column(u'mdm_devicegroup', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceGroup.priority'
        db.delete_column(u'mdm_devicegroup', 'priority')

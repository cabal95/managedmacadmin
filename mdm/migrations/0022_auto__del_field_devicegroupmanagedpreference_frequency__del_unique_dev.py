...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DeviceGroupManagedPreference.frequency'
        db.delete_column(u'mdm_devicegroupmanagedpreference', 'frequency')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DeviceGroupManagedPreference.frequency'
        raise RuntimeError("Cannot reverse this migration. 'DeviceGroupManagedPreference.frequency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceGroupManagedPreference.frequency'
        db.add_column(u'mdm_devicegroupmanagedpreference', 'frequency',
    ...
    models = {
        ...
        u'mdm.devicegroupmanagedpreference': {
            'Meta': {'unique_together': "(('group', 'application'),)", 'object_name': 'DeviceGroupManagedPreference'},

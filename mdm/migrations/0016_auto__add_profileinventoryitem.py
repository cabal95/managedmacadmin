...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProfileInventoryItem'
        db.create_table(u'mdm_profileinventoryitem', (
            ...
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=1024)),
            ('identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=36)),
        ))
        db.send_create_signal(u'mdm', ['ProfileInventoryItem'])


    def backwards(self, orm):
        # Deleting model 'ProfileInventoryItem'
        db.delete_table(u'mdm_profileinventoryitem')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProfileInventoryItem.uuid'
        db.alter_column(u'mdm_profileinventoryitem', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'ProfileInventoryItem.uuid'
        db.alter_column(u'mdm_profileinventoryitem', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=36))

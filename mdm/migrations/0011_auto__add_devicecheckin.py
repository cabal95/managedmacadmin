...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeviceCheckin'
        db.create_table(u'mdm_devicecheckin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mdm.Device'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('latitude', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('longitude', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('country_code', self.gf('django.db.models.fields.CharField')(default='', max_length=8)),
            ('region_code', self.gf('django.db.models.fields.CharField')(default='', max_length=16)),
            ('city', self.gf('django.db.models.fields.CharField')(default='', max_length=48)),
            ('country_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('region_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
        ))
        db.send_create_signal(u'mdm', ['DeviceCheckin'])


    def backwards(self, orm):
        # Deleting model 'DeviceCheckin'
        db.delete_table(u'mdm_devicecheckin')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.last_notification'
        db.add_column(u'mdm_device', 'last_notification',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 21, 0, 0)),
                      keep_default=False)

        # Adding field 'Device.type'
        db.add_column(u'mdm_device', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Device.os'
        db.add_column(u'mdm_device', 'os',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.last_notification'
        db.delete_column(u'mdm_device', 'last_notification')

        # Deleting field 'Device.type'
        db.delete_column(u'mdm_device', 'type')

        # Deleting field 'Device.os'
        db.delete_column(u'mdm_device', 'os')

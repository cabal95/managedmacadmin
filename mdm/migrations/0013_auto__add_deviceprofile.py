...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mdm_deviceprofile', (
            ...
            ('scope', self.gf('django.db.models.fields.IntegerField')()),
            ('removalDisallowed', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'mdm', ['DeviceProfile'])


    def backwards(self, orm):
        # Deleting model 'DeviceProfile'
        db.delete_table(u'mdm_deviceprofile')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field nestedGroups on 'DeviceGroup'
        db.delete_table(db.shorten_name(u'mdm_devicegroup_nestedGroups'))
    ...
    def backwards(self, orm):
        # Adding M2M table for field nestedGroups on 'DeviceGroup'
        m2m_table_name = db.shorten_name(u'mdm_devicegroup_nestedGroups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_devicegroup', models.ForeignKey(orm[u'mdm.devicegroup'], null=False)),
            ('to_devicegroup', models.ForeignKey(orm[u'mdm.devicegroup'], null=False))
    ...
    models = {
        ...
        u'mdm.devicegroup': {
            ...
            'nested_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mdm.DeviceGroup']", 'symmetrical': 'False'}),

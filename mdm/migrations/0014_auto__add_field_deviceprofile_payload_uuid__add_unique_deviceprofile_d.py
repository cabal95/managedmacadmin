...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceProfile.payload_uuid'
        db.add_column(u'mdm_deviceprofile', 'payload_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)

        # Adding unique constraint on 'DeviceProfile', fields ['device', 'identifier']
        db.create_unique(u'mdm_deviceprofile', ['device_id', 'identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'DeviceProfile', fields ['device', 'identifier']
        db.delete_unique(u'mdm_deviceprofile', ['device_id', 'identifier'])
    ...
    models = {
        ...
        u'mdm.deviceprofile': {
            ...
            'payload_uuid': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'removalDisallowed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'scope': ('django.db.models.fields.IntegerField', [], {}),

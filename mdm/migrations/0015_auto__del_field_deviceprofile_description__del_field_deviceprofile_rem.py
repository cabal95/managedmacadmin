...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeviceProfile.description'
        db.delete_column(u'mdm_deviceprofile', 'description')

        # Deleting field 'DeviceProfile.removalDisallowed'
        db.delete_column(u'mdm_deviceprofile', 'removalDisallowed')

        # Deleting field 'DeviceProfile.version'
        db.delete_column(u'mdm_deviceprofile', 'version')

        # Deleting field 'DeviceProfile.scope'
        db.delete_column(u'mdm_deviceprofile', 'scope')

        # Deleting field 'DeviceProfile.payload_uuid'
        db.delete_column(u'mdm_deviceprofile', 'payload_uuid')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DeviceProfile.description'
        raise RuntimeError("Cannot reverse this migration. 'DeviceProfile.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceProfile.description'
        db.add_column(u'mdm_deviceprofile', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024),
                      keep_default=False)

        # Adding field 'DeviceProfile.removalDisallowed'
        db.add_column(u'mdm_deviceprofile', 'removalDisallowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DeviceProfile.version'
        db.add_column(u'mdm_deviceprofile', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'DeviceProfile.scope'
        raise RuntimeError("Cannot reverse this migration. 'DeviceProfile.scope' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceProfile.scope'
        db.add_column(u'mdm_deviceprofile', 'scope',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'DeviceProfile.payload_uuid'
        raise RuntimeError("Cannot reverse this migration. 'DeviceProfile.payload_uuid' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceProfile.payload_uuid'
        db.add_column(u'mdm_deviceprofile', 'payload_uuid',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DeviceManagedPreference.application'
        db.delete_column(u'mdm_devicemanagedpreference', 'application')

        # Deleting field 'DeviceManagedPreference.frequency'
        db.delete_column(u'mdm_devicemanagedpreference', 'frequency')

        # Adding field 'DeviceManagedPreference.identifier'
        db.add_column(u'mdm_devicemanagedpreference', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding unique constraint on 'DeviceManagedPreference', fields ['device', 'identifier']
        db.create_unique(u'mdm_devicemanagedpreference', ['device_id', 'identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'DeviceManagedPreference', fields ['device', 'identifier']
        db.delete_unique(u'mdm_devicemanagedpreference', ['device_id', 'identifier'])


        # User chose to not deal with backwards NULL issues for 'DeviceManagedPreference.application'
        raise RuntimeError("Cannot reverse this migration. 'DeviceManagedPreference.application' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceManagedPreference.application'
        db.add_column(u'mdm_devicemanagedpreference', 'application',
                      self.gf('django.db.models.fields.CharField')(max_length=200),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'DeviceManagedPreference.frequency'
        raise RuntimeError("Cannot reverse this migration. 'DeviceManagedPreference.frequency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DeviceManagedPreference.frequency'
        db.add_column(u'mdm_devicemanagedpreference', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'DeviceManagedPreference.identifier'
        db.delete_column(u'mdm_devicemanagedpreference', 'identifier')

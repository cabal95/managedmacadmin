...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceCommand.attempts'
        db.add_column(u'mdm_devicecommand', 'attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DeviceCommand.date_completed'
        db.add_column(u'mdm_devicecommand', 'date_completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceCommand.attempts'
        db.delete_column(u'mdm_devicecommand', 'attempts')

        # Deleting field 'DeviceCommand.date_completed'
        db.delete_column(u'mdm_devicecommand', 'date_completed')
